                ...
                <div className="flex flex-col lg:flex-row lg:justify-between gap-8">
                    ...
                    <div className="lg:w-1/2 space-y-8">
                        ...
                        <p className="text-xl lg:text-3xl text-primary-100 leading-relaxed">
                            FOSS Cell is a technical club that promotes and strengthens the Free and
                            Open Source Software ecosystem in TKMCE.
                        </p>
                ...
                >
                    ...
                    <div className="lg:w-2/3">
                        ...
                        <p className="text-base text-pretty leading-relaxed">
                            ...
                            , who are passionate about Free and Open-Source Software (FOSS). Our
                            goal is to spread the knowledge of Free Software and raise awareness
                            about the four fundamental freedoms that come bundled with each of these
                            softwares. Our community is a bunch of enthusiastic free software
                            evangelists and hobbyist developers who are committed to promoting and
                            developing free software for the greater good.
                        </p>
                    </div>
                </section>
                ...
                >
                    <div className="lg:w-2/3">
                        ...
                        <p className="text-base text-pretty leading-relaxed">
                            ...
                            empower individuals to explore FOSS, develop new skills, and make a
                            meaningful impact. We foster collaboration, community building, and
                            inclusivity, organizing events to bring together global experts who
