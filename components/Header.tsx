...
export function Header(props: HeaderProps) {
    ...
    useEffect(() => {
        const elements = props.navbarSections?.map((section) => {
            ...
            if (element == null) throw new Error("Couldn't find element with ID for scrollspy.");
            return element;
        });
    ...
    return (
        ...
        >
            ...
            <nav id="navbar" className="w-full p-7 flex place-items-center justify-between">
                <Link href="/">
                ...
                <div onClick={toggleExpandedMenu} className="block lg:hidden cursor-pointer">
                    <FaBars size={24} />
                </div>
            </nav>
            <div className="block lg:hidden p-8 space-y-8 w-fit">
                {props.navbarSections != null && props.navbarSections.length > 0 && (
                    <div className="space-y-4">
                        <div className="uppercase text-sm text-neutral-400">In this page</div>
